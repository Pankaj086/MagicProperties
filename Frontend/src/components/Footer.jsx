      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="text-2xl font-bold text-white">MagicProperties</Link>
            <p className="mt-4 text-gray-400">
              Find your dream property with our extensive listings of properties for sale and rent.
              We connect buyers and sellers to make property transactions smooth and efficient.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-center">
                ...
                <span>info@magicproperties.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} MagicProperties. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
